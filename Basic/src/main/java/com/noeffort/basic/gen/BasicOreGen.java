package com.noeffort.basic.gen;
...
public class BasicOreGen implements IWorldGenerator {
    ...
    private WorldGenerator strange_ore, nether, end;

    public BasicOreGen() {
        strange_ore = new WorldGenMinable(BlockInit.strange_ore.getDefaultState(), 5);
        nether = new WorldGenMinable(BlockInit.nether_strange_ore.getDefaultState(), 5, BlockMatcher.forBlock(Blocks.NETHERRACK));
        end = new WorldGenMinable(BlockInit.end_strange_ore.getDefaultState(), 5, BlockMatcher.forBlock(Blocks.END_STONE));
    }

    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        switch(world.provider.getDimension()) {
            case 0:
                runGenerator(strange_ore, world, random, chunkX, chunkZ, 35, 15, 50);
                break;
