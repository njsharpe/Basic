...
public class BlockOres extends Block implements IHasModel, IMetaName
{
    ...
    private String name, dimenson;

    public BlockOres(String name, String dimenson)
    {
        super(Material.ROCK);
        setUnlocalizedName(name);
        setRegistryName(name);
        setCreativeTab(Basic.basictab);
        setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.STRANGE));
    ...
    public void registerModels()
    {
        ...
        {
            Basic.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ore_" + this.dimenson + "_" +  EnumHandler.EnumType.values()[i].getName(), "inventory");
        }
    }
}
