...
public class BlockSaplings extends BlockBush implements IGrowable, IMetaName, IHasModel
{
    ...
    public BlockSaplings(String name)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.STRANGE).withProperty(STAGE, Integer.valueOf(0)));
    ...
    public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
    {
        ...
        WorldGenerator worldgenerator = (WorldGenerator)(rand.nextInt(10) == 0 ? new WorldGenBigTree(false) : new WorldGenTrees(false));
        boolean flag = false;
        int i = 0, j = 0;
    ...
    public void registerModels()
    {
        ...
        {
            Basic.proxy.registerVariantRenderer(Item.getItemFromBlock(BlockInit.SAPLING), i, "sapling_" + EnumHandler.EnumType.values()[i].getName(), "inventory");
        }
    }
