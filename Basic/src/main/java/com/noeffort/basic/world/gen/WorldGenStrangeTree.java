...
import com.noeffort.basic.objects.blocks.BlockLeaf;
import com.noeffort.basic.objects.blocks.BlockLogs;
import com.noeffort.basic.objects.blocks.BlockSaplings;
...
{
    public static final IBlockState LOG = BlockInit.LOG.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumType.STRANGE);
    public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumType.STRANGE);
    ...
    public boolean generate(World world, Random rand, BlockPos pos)
    {
        ...
        else
        {
            ...
            boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockSaplings)BlockInit.SAPLING);
